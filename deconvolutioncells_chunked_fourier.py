...
from deconv import PsfFourierChunks
...
y_da = da.from_array(y, chunks=(3,) + chunk_shape)
# Stopping criterion
default_stop_crit = (
...
with pycrt.Precision(pycrt.Width.SINGLE):
    ...
    forwards = [PsfFourierChunks(psf_, chunk_shape, percentile=99.9) for psf_ in psf]
...
np.savez("x_tecons_tv_fft", x_recons_tv)
